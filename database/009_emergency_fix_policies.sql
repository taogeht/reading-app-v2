-- Emergency Fix: Disable problematic RLS policies causing infinite recursion
...
-- Drop recording policies
DROP POLICY IF EXISTS "Admins can view all recordings" ON public.recordings;
DROP POLICY IF EXISTS "Students can view their recordings" ON public.recordings;
