-- CORRECTED Complete Database Schema Setup for Reading Practice Platform
...
-- =============================================================================
-- CREATE VISUAL PASSWORDS TABLE (CORRECTED - without image_url initially)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS public.visual_passwords (
    ...
    name TEXT NOT NULL,
    display_emoji TEXT NOT NULL,  -- Using emoji instead of image_url for simplicity
    created_at TIMESTAMPTZ DEFAULT now() NOT NULL
);
...
-- Add visual_password_id foreign key to profiles if it doesn't exist (after visual_passwords table exists)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
...
-- =============================================================================
-- INSERT SAMPLE VISUAL PASSWORDS (CORRECTED)
-- =============================================================================
